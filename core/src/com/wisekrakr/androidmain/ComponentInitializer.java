...
public interface ComponentInitializer {
    ...
    void playerComponent(PooledEngine engine, Entity mainEntity, float x, float y, float radius, Entity attachedEntity, float penisLength, float penisGirth);
    void enemyComponent(PooledEngine engine, Entity mainEntity, float initialX, float initialY, float radius, EntityColor entityColor, Entity attachedEntity, float penisLength, float penisGirth);
    ...
    void penisComponent(PooledEngine engine, Entity mainEntity, Entity attachedEntity, float velocityX, float velocityY, float width, float height, float direction);
